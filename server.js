        ...
        app.post('/addUser', (req,res)=>{
            ...
            //JSON.stringify({SSN:SSN, fname: fname, lname:lname, dob:dob, phone:phone, email: email, address: address, gender:gender, password:password})
            ...
            connection.query('INSERT INTO patients(SSN, Fname, Lname, phone, dob, email, password, address, gender) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)',[SSN, fname, lname, phone, dob, email, password, address, gender], (error,result, fields )=>{
                if(error) throw error;
                if(result.length > 0){
                    res.redirect('/');
                }
